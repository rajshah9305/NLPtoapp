...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      {/* Main Content */}
      <main className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-3 sm:gap-4">
          ...
          <div className="lg:sticky lg:top-20 h-fit">
            <div className="relative">
              ...
              <div className="relative card-premium overflow-hidden shadow-2xl" style={{ minHeight: '350px', height: 'calc(100vh - 9rem)' }}>
